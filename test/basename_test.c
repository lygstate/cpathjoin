...
int basename_change_trim_only_root(void)
{
  ...
  n = cpj_path_change_basename("/", "///another.txt///", buffer,
    sizeof(buffer));
  if (n != 12) {
    return EXIT_FAILURE;
  }
...
int basename_change_trim(void)
{
  ...
  n = cpj_path_change_basename("/test.txt", "///another.txt///", buffer,
    sizeof(buffer));
  if (n != 12) {
    return EXIT_FAILURE;
  }
...
int basename_change_empty_basename(void)
{
  ...
  n = cpj_path_change_basename("C:\\test.txt", "", buffer, sizeof(buffer));
  if (n != 3) {
    return EXIT_FAILURE;
  }
...
int basename_change_only_root(void)
{
  ...
  n = cpj_path_change_basename("C:\\", "another.txt", buffer, sizeof(buffer));
  if (n != 14) {
    return EXIT_FAILURE;
  }
...
int basename_change_empty_path(void)
{
  ...
  n = cpj_path_change_basename("", "another.txt", buffer, sizeof(buffer));
  if (n != 11) {
    return EXIT_FAILURE;
  }
...
int basename_change_simple(void)
{
  ...
  n = cpj_path_change_basename("C:\\test.txt", "another.txt", buffer,
    sizeof(buffer));
  if (n != 14) {
    return EXIT_FAILURE;
  }
