 ...
 */
CPJ_PUBLIC size_t cpj_path_get_absolute(const char *base, const char *path,
 ...
 */
CPJ_PUBLIC size_t cpj_path_get_relative(const char *base_directory,
 ...
 */
CPJ_PUBLIC size_t cpj_path_join(const char *path_a, const char *path_b,
  char *buffer, size_t buffer_size);
 ...
 * @return Returns the total amount of characters of the full, combined path.
 */
CPJ_PUBLIC size_t cpj_path_join_multiple(const char **paths, char *buffer,
  size_t buffer_size);
 ...
 */
CPJ_PUBLIC void cpj_path_get_root(const char *path, size_t *length);
 ...
 */
CPJ_PUBLIC size_t cpj_path_change_root(const char *path, const char *new_root,
  char *buffer, size_t buffer_size);
 ...
 */
CPJ_PUBLIC bool cpj_path_is_absolute(const char *path);
 ...
 */
CPJ_PUBLIC bool cpj_path_is_relative(const char *path);
 ...
 */
CPJ_PUBLIC void cpj_path_get_basename(const char *path, const char **basename,
  size_t *length);
 ...
 * not truncated.
 */
CPJ_PUBLIC size_t cpj_path_change_basename(const char *path,
 ...
 */
CPJ_PUBLIC void cpj_path_get_dirname(const char *path, size_t *length);
 ...
 */
CPJ_PUBLIC bool cpj_path_get_extension(const char *path, const char **extension,
  size_t *length);
 ...
 */
CPJ_PUBLIC bool cpj_path_has_extension(const char *path);
 ...
 * truncated.
 */
CPJ_PUBLIC size_t cpj_path_change_extension(const char *path,
 ...
 * truncated.
 */
CPJ_PUBLIC size_t cpj_path_normalize(const char *path, char *buffer,
  size_t buffer_size);
 ...
 */
CPJ_PUBLIC size_t cpj_path_get_intersection(const char *path_base,
 ...
 */
CPJ_PUBLIC bool cpj_path_get_first_segment(const char *path,
 ...
 * @return Returns true if there is a segment or false if there is none.
 */
CPJ_PUBLIC bool cpj_path_get_last_segment(const char *path,
  struct cpj_segment *segment);
 ...
 */
CPJ_PUBLIC bool cpj_path_get_next_segment(struct cpj_segment *segment);
 ...
 * otherwise.
 */
CPJ_PUBLIC bool cpj_path_get_previous_segment(struct cpj_segment *segment);
 ...
 * was not truncated.
 */
CPJ_PUBLIC size_t cpj_path_change_segment(struct cpj_segment *segment,
 ...
 */
CPJ_PUBLIC bool cpj_path_is_separator(const char *str);
 ...
 */
CPJ_PUBLIC void cpj_path_set_style(enum cpj_path_style style);
 ...
 */
CPJ_PUBLIC enum cpj_path_style cpj_path_get_style(void);
